...
:
**Precise Strike.** Once per turn, when you hit a creature with a whip, instead of dealing damage you can choose an effect from the list below. The DC for saving throws to resist these effects is 8 + your Proficiency bonus + your Dexterity or Strength modifier (your choice).
...
- **Disarm.** The target must succeed on a Strength saving throw, or drop one item of your choice it is holding (not wearing). The creature has Advantage on this saving throw if the item is being held with two hands.
- **Pull.** The target must succeed on a Strength saving throw, or you pull the creature 5 feet towards you if it is the same size as you or smaller, otherwise you pull yourself 5 feet towards the target. This movement does not provoke opportunity attacks
- **Sweep.** The target must succeed on a Strength saving throw or be knocked prone. 
